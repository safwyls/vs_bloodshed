...
namespace Bloodshed.Config
{
    public class BloodshedConfig
    {
        ...
        public float MeleeAttackDamageExhausted { get; set; } = 0.5f; // 50%
        public float MeleeAttackSpeedExhausted { get; set; } = 0.5f; // 50%
        public float RangedAttackDamageExhausted { get; set; } = 0.5f; // 50%
        public float RangedAttackSpeedExhausted { get; set; } = 0.5f; // 50%
        public float RangedAttackAccuracyExhausted { get; set; } = 0.5f; // 50%
